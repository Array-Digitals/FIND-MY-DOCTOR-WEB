...
import { ReviewPopup } from "../../Component/reviewPopup";
 ...
 const DoctorBookingDetails = () => {
    let { DoctorBookingId } = useParams();
    // let serverUrl = "http://fmd.arraydigitals.com";
    const { DoctorBookingDetails } = UserData();
    ...
    useEffect(() => {
        DoctorBookingDetails(DoctorBookingId)
            .then((res) => {
                console.log(res?.data?.data, "booking Details");
                setTestBooking(res?.data?.data);
                setAllTests(res?.data?.data?.prescriptions);
            })
            .catch((res) => {
                console.log(res);
            });
    ...
    return (
        <React.Fragment>
            <main>
                                                    ...
                                                    <div className="mainBody">
                                                        ...
                                                        <div className="orderDetailsWrapper">
                                                            <div className="mainBodySection">
                                                                ...
                                                                {
                                                                    testBooking.specialist_category &&
                                                                    <div className="subHeading">
                                                                        Specialist Category:
                                                                        <span>
                                                                            {
                ...
                <ReviewPopup reviewRef={reviewDialog} reviewType={"doctor"} testProps={testBooking} />
            </main>
        </React.Fragment>
    )
}
