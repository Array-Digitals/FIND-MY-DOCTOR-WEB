...
export const BookingDetails = () => {
    ...
    useEffect(() => {
        getDoctor().then((res) => {
            ...
            // console.log(res?.data?.data, 'response');
            const physicalDoctors = allDoctors.filter(doctor => (doctor.consultation === 'physical') || (doctor.consultation === 'Physical'));
       console.log(physicalDoctors, 'physicals');
    ...
    const updateDoctorMod = () => {
        ...
        if (bookingPayload.doctor) {
            console.log(bookingPayload, 'payyyy');
                                                        ...
                                                        <span>
                                                            <select name="" id="" onChange={(e) => { setAssignedDoctor(e.target.value) }}>
                                                                ...
                                                                {allPhysicalDoctor.map((item, keyId) => (
                                                                    <option key={keyId} value={item.id}>{item.speciality}: {item.fullname}</option>
                                                                ))}
                                                            </select>
                                                        </span>
                                                    </div>
