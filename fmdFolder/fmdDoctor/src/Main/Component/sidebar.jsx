            ...
            <aside id="sidebar" className={sideBar ? 'sidebarwidth' : 'sidebar'}>
                <div className="sideBarInner">
                    ...
                    <ul className="sidebar-nav" id="sidebar-nav">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link  collapsed" activeclassname="active" to={ROUTES.REVIEWS}>
                                <i className="bi bi-person sideIcon" /><span>Reviews</span>
                            </NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link  collapsed" activeclassname="active" to={ROUTES.TERMS}>
                                <i className="bi bi-file-earmark-text sideIcon" /><span>Terms & Conditions</span>
                            </NavLink>
                        </li>
                        <li className="nav-item">
