...
export const LabCurrentOrders = () => {
    let { LabPersonalId } = useParams();
    const { getAppointmentDetailsLab } = AdminService();
    const [testDetail, setTestDetail] = useState([])
    const navigate = useNavigate()

    useEffect(() => {
        getAppointmentDetailsLab(LabPersonalId).then((res) => {
                    ...
                    <div className="container">
                        <div className="mainSectionWrapper">
                            <div className="heading">
                                <p>
                                    <button className='navigateBackButton' onClick={() => { navigate(-1) }}><i class="ri-arrow-left-line"></i></button>    Appointment Details
                                </p>
                            </div>
                                ...
                                <div className="card-body">
                                    {
                                        testDetail.length === 0 ?
                                            ...
                                            <div className="appointmentDetails ">
                                                ...
                                                {/* {testDetail.map((item, keyId) => (
                                            <div className="mainBody" key={keyId}>
